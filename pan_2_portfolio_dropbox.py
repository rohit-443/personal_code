...
data_df_filtered.to_csv('5_days_history_pan2.csv', index=False)
print("data_df_filtered saved to '5_days_history_pan2.csv'")
...
source_df = pd.read_csv("5_days_history_pan2.csv", dtype=dtypes)
