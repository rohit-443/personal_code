...
def run_portfolio(tickers, five_days_history_filename, target_history_filename):
    ...
    ticker_price_history_df= pd.read_csv(target_history_filename, usecols=['Date', 'Ticker', 'Close', 'High', 'Low', 'Open', 'Volume'], dtype=dtype_dict_hist, parse_dates=parse_dates_hist)
    ...
    data_df_filtered.to_csv(five_days_history_filename, index=False)
    print("data_df_filtered saved to five_days_history_filename")
    ...
    source_df = pd.read_csv(five_days_history_filename, dtype=dtypes)
