...
ticker_price_history_df= pd.read_csv("pan1_2year_history.csv", dtype= dtype_dict_hist, parse_dates=parse_dates_hist)
...
data_df_filtered.to_csv('5_days_history_pan1.csv', index=False)
print("data_df_filtered saved to '5_days_history_pan1.csv'")
...
source_df = pd.read_csv("5_days_history_pan1.csv", dtype=dtypes)
...
merged_df_pandas.to_csv("pan1_2year_history.csv", index=False)
